...
// This component shows recent inventory activity, with a badge indicating quantity change and a link to the inventory page for more details.
//  It fetches the 10 most recent movements and displays them in a scrollable list.
