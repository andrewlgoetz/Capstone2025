...
CATEGORY_KEYWORDS: dict[str, list[str]] = {
    "Canned Soup - Chicken / Meat": [
        "chicken soup", "chicken noodle", "beef soup", "meat soup",
        "chicken broth", "beef broth", "chicken stew", "beef stew",
    ],
    "Canned Soup - Vegetable": [
        "vegetable soup", "minestrone", "mixed vegetable soup",
    ],
    "Canned Soup - Tomato": ["tomato soup"],
    "Canned Soup - Cream / Bisque": [
        "cream of mushroom", "cream of chicken", "bisque", "cream soup",
    ],
    "Canned Soup - Bean / Lentil": [
        "lentil soup", "bean soup", "split pea soup", "pea soup",
    ],
    "Canned Soup - Other": [],
    "Canned Fish": [
        "canned tuna", "canned salmon", "sardines", "mackerel",
        "canned fish", "tuna in", "salmon in",
    ],
    "Canned Meat": [
        "canned chicken", "canned meat", "spam", "corned beef", "luncheon meat",
    ],
    "Canned Beans": [
        "canned beans", "black beans", "kidney beans", "chickpeas",
        "baked beans", "beans in brine", "beans in tomato",
    ],
    "Canned Protein - Other": [],
    "Meat - Ground Beef": [
        "ground beef", "beef mince", "minced beef", "lean ground beef",
    ],
    "Meat - Beef (Cuts / Roast)": [
        "beef steak", "roast beef", "brisket", "ribeye", "sirloin",
    ...
    "Meat - Sausage": [
        "sausage", "bratwurst", "chorizo", "kielbasa", "breakfast sausage",
    ],
    "Meat - Chicken (Whole / Pieces)": [
        "chicken breast", "chicken thigh", "chicken wings",
        "whole chicken", "rotisserie chicken", "chicken drumstick",
    ],
    "Meat - Ground Poultry": [
        "ground chicken", "ground turkey",
    ],
    "Meat - Turkey": [
        "turkey breast", "whole turkey", "turkey roast",
    ],
    "Meat - Fish / Seafood": [
        "salmon fillet", "tilapia", "shrimp", "seafood", "fish fillet",
        "cod fillet", "haddock",
    ],
    "Meat - Other": [],
    "Pasta - Long": [
    ...
    "Noodles - Instant / Asian": [
        "ramen", "instant noodles", "rice noodles", "chow mein noodles", "udon",
    ],
    "Pasta - Other": [],
    "Rice - White": [
    ...
    "Grains - Other": [],
    "Cereal - Ready to Eat": [
        "breakfast cereal", "cornflakes", "corn flakes", "oat rings",
        "puffed rice", "granola cereal", "corn pops", "rice krispies",
    ],
    "Cereal - Hot / Oatmeal": [
        "oatmeal", "rolled oats", "instant oats", "cream of wheat",
        "hot cereal", "porridge",
    ],
    "Bread": ["bread", "sliced bread", "buns", "rolls", "tortillas", "wraps"],
    "Crackers": ["crackers", "rice cakes", "crispbreads", "water crackers"],
    "Flour / Baking Supplies": [
        "flour", "baking powder", "baking mix", "pancake mix", "cake mix",
    ],
    "Baked Goods - Other": [],
    ...
    "Pasta / Tomato Sauce": [
        "pasta sauce", "marinara", "tomato sauce", "bolognese", "arrabiata",
    ],
    "Cooking Sauces": [
    ...
    "Condiments": [
        ...
        "salad dressing", "vinegar", "worcestershire",
    ],
    "Sauces / Condiments - Other": [],
    "Peanut Butter": ["peanut butter", "almond butter", "nut butter"],
    "Jam / Jelly": ["jam", "jelly", "marmalade", "fruit spread", "fruit preserve"],
    "Other Spreads": ["honey", "maple syrup", "hazelnut spread", "nutella"],
    ...
    "Juice": [
        "apple juice", "orange juice", "grape juice", "cranberry juice",
        "fruit juice", "juice drink",
    ],
    "Water": ["water", "sparkling water", "mineral water"],
    "Coffee / Tea": [
        "coffee", "instant coffee", "tea bags", "herbal tea", "ground coffee",
    ],
    "Beverages - Other": [],
    "Chips / Crisps": [
